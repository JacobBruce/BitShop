...
class bitcoin {
  ...
  public static $address_testver = "6F";
  public static $privkey_testver = "EF";
  
  public static function valid_address_versions() {
...
*/
  public static function checkAddress($addr) {
    ...
    if (!in_array($version, self::valid_address_versions())) {
